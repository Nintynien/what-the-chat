...
parser.add_argument(
    "--model",
    default="gpt-4-turbo",
    help="Name of the model to use (default: gpt-4-turbo)",
)
parser.add_argument(
    "--dump-file",
    nargs="?",
...
async def fetch_discord_messages(
    ...
    """
    print(f"\n{Fore.CYAN}→ Fetching messages from Discord channel {Fore.YELLOW}{channel_id}{Fore.CYAN} since {Fore.GREEN}{since_date}{Style.RESET_ALL}")
